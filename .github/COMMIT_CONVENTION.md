...
> 💡 **Impacto en SemVer:** Cualquier commit con un `BREAKING CHANGE` en el footer forzará un incremento de versión mayor (*Major Release*), independientemente del tipo.
