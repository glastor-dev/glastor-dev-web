      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="lg:col-span-5 space-y-8">
             ...
             <div className="flex flex-col gap-4 p-5 bg-white/[0.02] border border-white/5 rounded-2xl backdrop-blur-sm">
                ...
                <div className="flex justify-between text-[8px] mono text-gray-600 font-black">
                   ...
                   <span>REGION: ES_NODE_ALPHA</span>
                </div>
             </div>
          </div>
            ...
            <div className="p-6 bg-gradient-to-br from-white/[0.03] to-transparent border border-white/10 rounded-3xl relative">
               ...
               <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-1 mb-2">
                    <span className="text-[10px] text-white mono font-black">GLASTOR® marca registrada en Argentina (INPI) — Reg. 4559568 (Clase 42) y 4559567 (Clase 35), 19/08/2025.</span>
                    <span className="text-[10px] text-gray-600 mono">GPL v3.0 Software Freedom Conservancy</span>
                  </div>
                  <ul className="flex flex-col gap-1 mt-2">
                    <FooterLink label="Aviso Legal" onClick={() => openLegal('legal')} />
                    <FooterLink label="Términos de Uso" onClick={() => openLegal('terminos')} />
                    <FooterLink label="Política de Privacidad" onClick={() => openLegal('privacidad')} />
                    <FooterLink label="Política de Cookies" onClick={() => openLegal('cookies')} />
                  </ul>
               </div>
            </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
           <div className="flex items-center gap-8 opacity-40 grayscale hover:grayscale-0 transition-all">
             <img src="https://i.postimg.cc/PxWYdHPN/gplv3-with-text-136x68.png" alt="GPLv3" className="h-10 md:h-12" />
             <div className="h-6 md:h-8 w-px bg-white/20"></div>
             <div className="flex flex-col">
               <span className="text-[14px] md:text-[18px] text-white mono font-bold">GL-CORE-V3</span>
               <span className="text-[11px] md:text-[13px] text-gray-500 mono">Kernel_Stable_v3.2.1</span>
             </div>
           </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-2 md:gap-4 md:justify-end text-center md:text-right">
            <div>
              <p className="text-gray-600 text-[10px] mono uppercase tracking-[0.3em]">
                © {currentYear} GLASTOR. <span className="text-white font-black">TODOS_LOS_DERECHOS_RESERVADOS.</span>
              </p>
               <p className="text-gray-800 text-[11px] md:text-[12px] mono mt-1">Sincronización de canal seguro vía AES-256-GCM</p>
            </div>
            <a
